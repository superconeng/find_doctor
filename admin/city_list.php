<?php
session_start();
require_once "includes/database.php"; // Make sure this file correctly connects to your DB
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="d-flex justify-content-between my-3">
                ...
                <div>
                    <a href="new_city.php" class="btn btn-added btn-primary">Add City
                ...
                <?php endif; ?>
                    ...
                    <div class="table-responsive">
                        <table class="table datanew">
                            ...
                            <tbody>
                                <?php
                                $sql = "SELECT * FROM mt_city ORDER BY id DESC";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="seri-no">
                                            <a href="new_city.php?id=<?php echo $row['id']; ?>" class="btn btn-edit">
                                                <img src="assets/img/icons/edit.svg" class="action-icon">
                                            </a>
                                        </td>
                                        <td class="seri-no">
                                           <a href="city_delete.php?id=<?php echo $row['id']; ?>" class="btn btn-delete">
