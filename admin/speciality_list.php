    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="d-flex justify-content-between my-3">
                ...
                <div>
                    <a href="new_speciality.php" class="btn btn-added btn-primary">Add Speciality
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table datanew">
                            ...
                            <tbody>
                                <?php
                                $sql = "SELECT * FROM speciality ORDER BY id DESC";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="new_speciality.php?id=<?php echo $row['id']; ?>" class="btn btn-edit">
                                                <img src="assets/img/icons/edit.svg" class="action-icon">
                                            </a>
                                        </td>
                                        <td>
                                            <a href="speciality_delete.php?id=<?php echo $row['id']; ?>" class="btn btn-delete" onclick="return confirm('Are you sure you want to delete this speciality?');">
