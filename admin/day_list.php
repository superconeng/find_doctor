    ...
    <div class="page-wrapper">
        <div class="content">
            <div class="d-flex justify-content-between my-3">
                ...
                <div>
                    <a href="new_day.php" class="btn btn-added btn-primary">Add Day
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table datanew">
                            ...
                            <tbody>
                                <?php
                                $sql = "SELECT * FROM mt_day ORDER BY id DESC";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="seri-no">
                                            <a href="new_day.php?id=<?php echo $row['id']; ?>" class="btn btn-edit">
                                                <img src="assets/img/icons/edit.svg" class="action-icon">
                                            </a>
                                        </td>
                                        <td class="seri-no">
                                            <a href="day_delete.php?id=<?php echo $row['id']; ?>" class="btn btn-delete">
