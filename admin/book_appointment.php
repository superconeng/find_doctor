...
<div class="max-w-2xl mx-auto py-6 space-y-6">
    ...
    <div class="bg-white rounded-xl p-5 shadow">
        <div class="flex space-x-4">
           <img class="sesoft-profile-img rounded-full h-24 w-24 object-cover" 
    src="<?= !empty($doctor['image']) ? 
        '../uploads/doctors/' . htmlspecialchars($doctor['image']) : 
        ($doctor['gender'] == 'female' ? '../images/icons/girl.jpg' : '../images/icons/men.jpg') 
    ?>" 
    alt="Dr. <?= htmlspecialchars(strip_tags($doctor['name'])) ?>">
